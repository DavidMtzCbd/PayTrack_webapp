...
const session_cookie_name = 'paytrack-token';
const user_email_cookie_name = 'paytrack-email';
const user_id_cookie_name = 'paytrack-user_id';
const user_complete_name_cookie_name = 'paytrack-user_complete_name';
const group_name_cookie_name = 'paytrack-group_name';
const codigo_cookie_name = 'paytrack-codigo';
...
saveUserData(user_data: any) {
  ...
  this.cookieService.set(user_id_cookie_name, user_data.user_id, undefined, undefined, undefined, secure, secure ? "None" : "Lax");
  this.cookieService.set(user_email_cookie_name, user_data.email, undefined, undefined, undefined, secure, secure ? "None" : "Lax");
  this.cookieService.set(user_complete_name_cookie_name, user_data.username, undefined, undefined, undefined, secure, secure ? "None" : "Lax");
  ...
  // Opcional: Si tienes más datos específicos del Cliente
  if (user_data.cliente_id) {
    this.cookieService.set('paytrack-cliente_id', user_data.cliente_id, undefined, undefined, undefined, secure, secure ? "None" : "Lax");
  }
}
  destroyUser(){
